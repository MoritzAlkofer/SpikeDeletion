...
def dataset_center():
    ...
    df = pd.read_csv('/home/moritz/Desktop/programming/SpikeDeletion_clean/tables/lut_event_23-08-22.csv')
    df['dataset'] = 'center' 
...
def dataset_member():
    # cluster member
    df = pd.read_csv('/home/moritz/Desktop/programming/SpikeDeletion_clean/tables/member_17JAN24.csv')
    df = df[df.total_votes_received>2]
    df['dataset'] = 'member' 
    p = [0.9, 0.1] 
